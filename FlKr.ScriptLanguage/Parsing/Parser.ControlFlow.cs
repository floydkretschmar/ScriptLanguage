...
public partial class Parser
{
    ...
    private Expression ParseConditionalInstructionExpression(List<IToken> expression, ParsingContext context)
    {
        ...
        var condition = ParseConditionExpression(subexpression, context);
        var conditionBlock =
        ...
        var alternateConditions =
            new List<Expression>();
        var alternateConditionBlocks =
            new List<Expression>();
        ...
        if (alternateConditionBlocks.Count > 0 || elseBlock != null)
        {
            if (alternateConditionBlocks.Count > 0)
            {
                ...
                for (var i = alternateConditionBlocks.Count - 1; i >= 0; i--)
